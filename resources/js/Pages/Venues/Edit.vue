                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                ...
                                <TextInput id="venue_name" type="text" class="mt-1 block w-full"
                                    v-model="form.venue_name" required autofocus />
                            ...
                            <div class="mb-4">
                                ...
                                <TextInput id="venue_address" type="text" class="mt-1 block w-full"
                                    v-model="form.venue_address" required />
                            ...
                            <div class="mb-4">
                                ...
                                <TextInput id="venue_max_capacity" type="number" class="mt-1 block w-full"
                                    v-model="form.venue_max_capacity" required min="1" />
