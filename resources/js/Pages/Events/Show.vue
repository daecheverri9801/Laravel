                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ event.event_is_virtual ?
                                        'Yes' :
                                        'No' }}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ event.event_speaker_name }}
                                    </p>
                                </div>

                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Venue</p>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ event.venue ?
                                        event.venue.venue_name : 'No venue assigned' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
