                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                ...
                                <TextInput id="event_name" type="text" class="mt-1 block w-full"
                                    v-model="form.event_name" required autofocus />
                            ...
                            <div class="mb-4">
                                ...
                                <input id="event_date" type="datetime-local"
                                    ...
                                    v-model="form.event_date" required />
                                <InputError class="mt-2" :message="form.errors.event_date" />
                            </div>

                            <div class="mb-4">
                                <div class="flex items-center">
                                    <input id="event_is_virtual" type="checkbox"
                                    ...
                                    <InputLabel for="event_is_virtual" value="Is Virtual Event?"
                            ...
                            <div class="mb-4">
                                ...
                                <TextInput id="event_speaker_name" type="text" class="mt-1 block w-full"
                                    v-model="form.event_speaker_name" required />
                            ...
                            <div class="mb-4">
                                ...
                                <select id="fk_venue_event" v-model="form.fk_venue_event"
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
